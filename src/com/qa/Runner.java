...
//		examplePerson.speak();
//		exampleTrainee.speak();
		
//	System.out.println("this is my" + Person.getEmployee());
		
//*************Garage************		
		
//		Car BW = new Car(2,"BMW", 10000, "Red", 2010, 4);
//	
//	    Motercycle running = new Motercycle (4, "BOBO", 0, "Gray", 2018);
//	    Bike lili = new Bike(3,"GOGO",2344, "white", 2000, true);
